...
WebUI.setText(findTestObject('Object Repository/TextBoxOR/input_Full Name_userName'), 'tesetruser')

WebUI.setText(findTestObject('Object Repository/TextBoxOR/input_Email_userEmail'), 'testuser@test.com')

WebUI.setText(findTestObject('Object Repository/TextBoxOR/textarea_Current Address_currentAddress'), 'test user adress')
